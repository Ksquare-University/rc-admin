...
export const UserInfoSideBar = () => {
    ...
    const [currentInfo, setCurrentInfo] = useState(['Jose Perez APerez', 'josePere@email.com', '809-574-3506'])
    

  
    const onInputChange = ({ target }) => {
        setCurrentInfo(target.value);
    };
...
/*         element.value = currentInfo[index] */
    ...
    <div className="User-Info-Box">
        ...
        <div className='User-info-box-child' >
            ...
            className='edit-information'>Edit information <i className="fa-regular fa-pen-to-square"></i></button>
        </div>

        <div className='Values-inputs-box'>
            <input className="Input-element" disabled= {true} type="text" value={currentInfo[0]}/>
            <input className="Input-element" disabled= {true} type="email" placeholder={currentInfo[1]}/>
            <input className="Input-element" disabled= {true} type="tel" placeholder={currentInfo[2]}  />
        </div>
        ...
        <div className='Buttons-Edit-Box'>
            ...
            onClick={()=>{handleOnClickDone()}}>Done</button>
        </div>
